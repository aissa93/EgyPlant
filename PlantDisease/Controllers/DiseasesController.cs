...
namespace PlantDisease.Controllers
{
    public class DiseasesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description,CreationDate,CreatedBy")] Disease disease)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description,CreationDate,CreatedBy")] Disease disease)
        {
            if (ModelState.IsValid)
            {
